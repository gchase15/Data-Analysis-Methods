...
clear all; close all; clc
     mainpath = 'C:\Users\gavin\Documents\MATLAB\HW4Music\Test2Samples';
D=dir(fullfile(mainpath,'BarlowGirl*cropped.jpg'));  
Band1Samp=[];
Band1AveSamp=[];
...
%     D=dir(fullfile(mainpath,'DavidCrowder*cropped.jpg'));  
% Band3Samp=[];
% Band3AveSamp=[];
% 
%     for j=1:numel(D)
...
%     end   
        ...
        D=dir(fullfile(mainpath,'Newsboys*cropped.jpg'));  
Band4Samp=[];
Band4AveSamp=[];
...
%     band3_wave = dc_wavelet(Band3AveSamp);
    ...
    feature = 36; %must be <= the number of samples per band
    
   [U,S,V]=svd([band1_wave,band2_wave,band4_wave],0);
...
xband1 = V(1:12,1:11); xband2 = V(13:24,1:11);
xband3 = V(25:36,1:11); 
% xband4 = V(37:48,1:16);
...
figure(6)
subplot(1,3,1)
histogram(band1pretree,3,'BinWidth',.8)
axis([1 3 0 5000]), xticks([1.2 2 2.8]),xticklabels({'Barlow Girl', 'Third Day', 'Newsboys'})
set(gca,'YTick',[1000 2000 3000 4000 5000], 'Fontsize',[12])
subplot(1,3,2)
histogram(band2pretree,3,'BinWidth',.8), axis([1 3 0 5000])
xticks([1.2 2 2.8]),xticklabels({'Barlow Girl', 'Third Day', 'Newsboys'})
set(gca,'YTick',[1000 2000 3000 4000 5000], 'Fontsize',[12])
subplot(1,3,3)
histogram(band3pretree,3,'BinWidth',.8), axis([1 3 0 5000])
xticks([1.2 2 2.8]),xticklabels({'Barlow Girl', 'Third Day', 'Newsboys'})
set(gca,'YTick',[1000 2000 3000 4000 5000], 'Fontsize',[12])
% subplot(1,4,4)
% histogram(band4prenb,4), axis([1 4 0 5000])
% xticks([1.2 2 3 3.8]),xticklabels({'Barlow Girl', 'Third Day', 'David Crowder', 'Newsboys'})
% set(gca,'YTick',[1000 2000 3000 4000 5000], 'Fontsize',[12])
